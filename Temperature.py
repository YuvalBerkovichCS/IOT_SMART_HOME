...
global clientname, CONNECTED, temperature_current
CONNECTED = False
r=random.randrange(1,10000000)
clientname="IOT_client-Id234-"+str(r)
DHT_topic = 'pr/home/yb/dht/sts'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("Noise",self.Noise)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Room Temperature')        
    ...
    def update_data(self):
        ...
        if(temperature_current < temperature_min_THR):
            temperature_current= round(temperature_current + random.randrange(1,10)/10,2)
        if(temperature_current > temperature_max_THR):
            temperature_current= round(temperature_current - random.randrange(1,10)/10,2)
        else:
            temperature_current= round(temperature_current + random.choice([-1, 1]) * random.randrange(1,10)/10,2)
        noise_current = random.randint(0, 1)
        current_data='Temperature: '+str(temperature_current) + ' Noise: ' + str(noise_current)
        self.connectionDock.Temperature.setText(str(temperature_current))        
        self.connectionDock.Noise.setText(str(noise_current))        
